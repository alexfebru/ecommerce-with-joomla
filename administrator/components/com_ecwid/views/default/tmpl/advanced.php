...
<form class="pure-form pure-form-aligned ecwid-settings advanced-settings ec-additional-settings-v<?php echo JVersion::MAJOR_VERSION;?>"
  id="adminForm"
  method="POST"
...
<fieldset>
    ...
    <div class="pure-control-group">
		...
		<?php if (!Ecwid::getApiV3()->getToken()): ?>
            <div>
        ...
        <?php elseif (!Ecwid::isPaidAccount()): ?>
            <div>
